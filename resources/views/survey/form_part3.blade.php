...
@section('title', 'แบบสอบถามตอนที่ 3')
...
<div class="min-h-screen pt-24 pb-12 bg-slate-50 font-sans">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="{{ route('survey.part2', ['id' => $control->ID]) }}" 
            ...
            <h1 class="text-xl md:text-2xl font-bold text-indigo-900">
                ตอนที่ 3 ค่าใช้จ่ายของสถานประกอบการ
            </h1>
        </div>

        <form action="{{ route('survey.storePart3') }}" method="POST">
            @csrf

            <input type="hidden" name="id" value="{{ $control->ID }}">

            <div class="space-y-6">
                <x-card title="ข้อ 9: ค่าใช้จ่าย..." class="!overflow-visible">
                </x-card>
            </div>
